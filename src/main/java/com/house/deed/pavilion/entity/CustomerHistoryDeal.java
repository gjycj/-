...
@ApiModel(value = "CustomerHistoryDeal对象", description = "客户历史成交记录表（租户级数据）")
public class CustomerHistoryDeal implements Serializable {
    ...
    @ApiModelProperty("历史成交合同ID（关联contract表，同租户）")
    ...
    @ApiModelProperty("成交房源简要信息（如XX小区3室2厅）")
    @TableField("house_info")
    private String houseInfo;

    @ApiModelProperty("成交类型（SALE-买卖，RENT-租赁）")
